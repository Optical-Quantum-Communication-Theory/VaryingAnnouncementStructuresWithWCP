function [newParams,modParser] = SARG04WCP2DescriptionFunc(params, options, debugInfo)
% Input parameters:
...
%% Kraus Ops
krausOps = {Improved_Kraus2(1,POVMsA,pz),Improved_Kraus2(2,POVMsA,pz),Improved_Kraus2(3,POVMsA,pz),Improved_Kraus2(4,POVMsA,pz)};
debugInfo.storeInfo("krausOps",krausOps);
krausSum = 0;
...
% note that we do not have blockdiag structure. The following info is not
% used.
...
function[kraus] = Improved_Kraus2(a,POVMsA,pz)
% A function to calculate the Kraus operators
% Note that here the Kraus Operators are simplified using isometries.
kraus = 0;
ketP = [1;1]/sqrt(2);
ketM = [1;-1]/sqrt(2);
