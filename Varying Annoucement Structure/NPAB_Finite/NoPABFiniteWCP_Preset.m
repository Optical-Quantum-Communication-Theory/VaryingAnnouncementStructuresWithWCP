function qkdInput = NoPABFiniteWCP_Preset()
...
%simulation photon number cutoff
...
qkdInput.addFixedParameter("t", 0); %Keep zero for adaptive length
qkdInput.addFixedParameter("pGen", 0.85);


%% modules

descriptionModule = QKDDescriptionModule(@NoPABFiniteWCP_DescriptionFunc);
...
keyRateModule = QKDKeyRateModule(@NoPABFiniteWCP_KeyRateFunc);
